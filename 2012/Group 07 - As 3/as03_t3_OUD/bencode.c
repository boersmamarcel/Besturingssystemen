 ...
 * the long type.  Any sane system should provide all of these things.
 *
...
static long _be_decode_int(const char **data, long *data_len)
{
	char *endp;
...
static char *_be_decode_str(const char **data, long *data_len)
{
	long sllen = _be_decode_int(data, data_len);
	long slen = sllen;
	unsigned long len;
	char *ret = NULL;
...
static be_node *_be_decode(const char **data, long *data_len)
{
	be_node *ret = NULL;
...
be_node *be_decoden(const char *data, long len)
{
